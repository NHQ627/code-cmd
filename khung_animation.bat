...
for /F "Tokens=1-13 Delims={}" %%A in ("%Khung%") Do (
 ...
 if /I "!huong!"=="phải" (
  ...
  for /L %%a in (!Y1!,1,!Y2!) do (
   <nul set /p =" %Esc%[%%a;!Xx!H!khung1!"
  )
  <nul set /p =" %Esc%[!Y!;!Xx!H!goc2!%Esc%[!Yy!;!Xx!H!goc4!"

  for /L %%a in (!X2!,-1,!X1!) do (
   <nul set /p =" %Esc%[!Y!;%%aH!khung2!%Esc%[!Yy!;%%aH!khung2!"
   For /L %%d in (1,1,%%M)Do Call :Delay 2> nul
  )

  for /L %%a in (!Y1!,1,!Y2!) do (
   <nul set /p =" %Esc%[%%a;!X!H!khung1!"
  )
  <nul set /p =" %Esc%[!Y!;!X!H!goc1!%Esc%[!Yy!;!X!H!goc3!"
  ...
  for /L %%a in (!X1!,1,!X2!) do (
   <nul set /p =" %Esc%[!Y!;%%aH!khung2!"
  )
  <nul set /p =" %Esc%[!Y!;!X!H!goc1!%Esc%[!Y!;!Xx!H!goc2!"

  for /L %%a in (!Y1!,1,!Y2!) do (
   <nul set /p =" %Esc%[%%a;!X!H!khung1!%Esc%[%%a;!Xx!H!khung1!"
   For /L %%d in (1,1,%%M)Do Call :Delay 2> nul
  )

  for /L %%a in (!X1!,1,!X2!) do (
   <nul set /p =" %Esc%[!Yy!;%%aH!khung2!"
  )
  <nul set /p =" %Esc%[!Yy!;!X!H!goc3!%Esc%[!Yy!;!Xx!H!goc4!"
